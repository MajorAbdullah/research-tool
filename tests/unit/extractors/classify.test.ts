...
describe('classifyKind', () => {
  const cases: Array<[label: string, url: string, expected: ItemKind]> = [
    ...
    ['a twitter.com status URL (aliases to x.com)', 'https://twitter.com/user/status/12345', ItemKind.Social],
    ...
    ['a direct .pdf URL on an arbitrary host', 'https://example.com/papers/report.pdf', ItemKind.Pdf],
    ['a .pdf URL is matched case-insensitively', 'https://example.com/papers/REPORT.PDF', ItemKind.Pdf],
